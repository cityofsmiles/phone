...
static Key keys[] = {
  /* PP */
	...
	{ 0, MODKEY|Mod4Mask,           XK_r,          spawn,          SHCMD("cd /home/jonathan/Documents/notes/recipes && mousepad") },
	...
	{ 0, Mod4Mask,                  XK_Up,         spawn,          SHCMD("xdotool key --clearmodifiers Prior") },
	{ 0, Mod4Mask,                  XK_Down,       spawn,          SHCMD("xdotool key --clearmodifiers Next") },
	{ 0, Mod4Mask,                  XK_Left,       spawn,          SHCMD("xdotool key --clearmodifiers Home") },
	{ 0, Mod4Mask,                  XK_Right,      spawn,          SHCMD("xdotool key --clearmodifiers End") },
	{ 0, MODKEY|Mod4Mask,           XK_Up,         spawn,          SHCMD("xdotool key --clearmodifiers Alt+Prior") },
	{ 0, MODKEY|Mod4Mask,           XK_Down,       spawn,          SHCMD("xdotool key --clearmodifiers Alt+Next") },
	{ 0, Mod4Mask|ShiftMask,        XK_Up,         spawn,          SHCMD("xdotool key --clearmodifiers Shift+Prior") },
	{ 0, Mod4Mask|ShiftMask,        XK_Down,       spawn,          SHCMD("xdotool key --clearmodifiers Shift+Next") },
	{ 0, Mod4Mask|ShiftMask,        XK_Left,       spawn,          SHCMD("xdotool key --clearmodifiers Shift+Home") },
	{ 0, Mod4Mask|ShiftMask,        XK_Right,      spawn,          SHCMD("xdotool key --clearmodifiers Shift+End") },
