...
static Key keys[] = {
  /* PP */
	...
	{ 0, MODKEY,                    XK_q,          spawn,          SHCMD("firefox https://reddit.com") },
	...
	{ 0, MODKEY,                    XK_w,          spawn,          SHCMD("firefox -profile '/home/alarm/Documents/phone/firefox-profiles/fb-work' https://m.facebook.com/messages/") },
	...
	{ 0, MODKEY,                    XK_x,          spawn,          SHCMD("xfce4-terminal --command='poweroff'") },
	{ 0, MODKEY,                    XK_z,          spawn,          SHCMD("xfce4-terminal --command='reboot'") },
