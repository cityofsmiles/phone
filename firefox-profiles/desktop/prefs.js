...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1615082569);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1614491254);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1617788471);
user_pref("app.update.lastUpdateTime.region-update-timer", 1616153021);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1614491374);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1614491614);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1613604769);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1615082689);
...
user_pref("browser.region.update.updated", 1616153022);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1616153001183");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1616174601183");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210323083042");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1617788469");
...
user_pref("browser.startup.lastColdStartupCheck", 1617788465);
...
user_pref("dom.push.userAgentID", "38dc74940d91404999216a4761d44e07");
user_pref("extensions.activeThemeID", "default-theme@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1615082577);
...
user_pref("media.gmp-manager.lastCheck", 1614491250);
...
user_pref("security.remote_settings.intermediates.checked", 1614491614);
...
user_pref("services.blocklist.addons-mlbf.checked", 1616153001);
user_pref("services.blocklist.gfx.checked", 1616153001);
user_pref("services.blocklist.pinning.checked", 1613604408);
user_pref("services.blocklist.plugins.checked", 1616153001);
user_pref("services.settings.clock_skew_seconds", 1);
user_pref("services.settings.last_etag", "\"1616140649876\"");
user_pref("services.settings.last_update_seconds", 1616153001);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1616153001);
user_pref("services.settings.main.cfr-fxa.last_check", 1616153001);
user_pref("services.settings.main.cfr.last_check", 1616153001);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1616153001);
user_pref("services.settings.main.hijack-blocklists.last_check", 1616153001);
user_pref("services.settings.main.language-dictionaries.last_check", 1616153001);
user_pref("services.settings.main.message-groups.last_check", 1616153001);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1616153001);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1616153001);
user_pref("services.settings.main.password-recipes.last_check", 1616153001);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1616153001);
user_pref("services.settings.main.public-suffix-list.last_check", 1616153001);
user_pref("services.settings.main.search-config.last_check", 1616153001);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1616153001);
user_pref("services.settings.main.search-telemetry.last_check", 1616153001);
user_pref("services.settings.main.sites-classification.last_check", 1616153001);
user_pref("services.settings.main.top-sites.last_check", 1616153001);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1616153001);
user_pref("services.settings.main.whats-new-panel.last_check", 1616153001);
user_pref("services.settings.security.onecrl.checked", 1614491614);
user_pref("services.sync.clients.lastSync", "0");
user_pref("services.sync.declinedEngines", "");
user_pref("services.sync.globalScore", 0);
user_pref("services.sync.nextSync", 0);
user_pref("services.sync.tabs.lastSync", "0");
user_pref("toolkit.startup.last_success", 1617788454);
