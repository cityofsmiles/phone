...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1616284523);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1616295455);
...
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1616205718);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1615772923);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1616203229);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1616295304233");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1616297087233");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1616284518091");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1616306118091");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210311122254");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1616295430");
user_pref("browser.slowStartup.averageTime", 4367);
...
user_pref("browser.startup.lastColdStartupCheck", 1616295428);
...
user_pref("dom.push.userAgentID", "1b64855ea6b845c5b65da0efe2ee1cea");
...
user_pref("services.blocklist.addons-mlbf.checked", 1616295298);
user_pref("services.blocklist.gfx.checked", 1616295298);
user_pref("services.blocklist.pinning.checked", 1616234631);
user_pref("services.blocklist.plugins.checked", 1616295298);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1616291861197\"");
user_pref("services.settings.last_update_seconds", 1616295298);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1616295298);
user_pref("services.settings.main.cfr-fxa.last_check", 1616295298);
user_pref("services.settings.main.cfr.last_check", 1616295298);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1616295298);
user_pref("services.settings.main.hijack-blocklists.last_check", 1616295298);
user_pref("services.settings.main.language-dictionaries.last_check", 1616295298);
user_pref("services.settings.main.message-groups.last_check", 1616295298);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1616295298);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1616295298);
user_pref("services.settings.main.password-recipes.last_check", 1616295298);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1616295298);
user_pref("services.settings.main.public-suffix-list.last_check", 1616295298);
user_pref("services.settings.main.search-config.last_check", 1616295298);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1616295298);
user_pref("services.settings.main.search-telemetry.last_check", 1616295298);
user_pref("services.settings.main.sites-classification.last_check", 1616295298);
user_pref("services.settings.main.top-sites.last_check", 1616295298);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1616295298);
user_pref("services.settings.main.whats-new-panel.last_check", 1616295298);
...
user_pref("toolkit.startup.last_success", 1616295424);
