...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1616984256122");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1616986029122");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1616984243");
user_pref("browser.slowStartup.averageTime", 9148);
...
user_pref("browser.startup.lastColdStartupCheck", 1616984240);
...
user_pref("dom.push.userAgentID", "d40b176a5b4e4d798467ea6c5db4c863");
...
user_pref("services.blocklist.addons-mlbf.checked", 1616984246);
user_pref("services.blocklist.gfx.checked", 1616984246);
user_pref("services.blocklist.pinning.checked", 1616234631);
user_pref("services.blocklist.plugins.checked", 1616984246);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1616983124345\"");
user_pref("services.settings.last_update_seconds", 1616984246);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1616984246);
user_pref("services.settings.main.cfr-fxa.last_check", 1616984246);
user_pref("services.settings.main.cfr.last_check", 1616984246);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1616984246);
user_pref("services.settings.main.hijack-blocklists.last_check", 1616984246);
user_pref("services.settings.main.language-dictionaries.last_check", 1616984246);
user_pref("services.settings.main.message-groups.last_check", 1616984246);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1616984246);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1616984246);
user_pref("services.settings.main.password-recipes.last_check", 1616984246);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1616984246);
user_pref("services.settings.main.public-suffix-list.last_check", 1616984246);
user_pref("services.settings.main.search-config.last_check", 1616984246);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1616984246);
user_pref("services.settings.main.search-telemetry.last_check", 1616984246);
user_pref("services.settings.main.sites-classification.last_check", 1616984246);
user_pref("services.settings.main.top-sites.last_check", 1616984246);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1616984246);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1616984246);
user_pref("services.settings.main.whats-new-panel.last_check", 1616984246);
...
user_pref("toolkit.startup.last_success", 1616984231);
