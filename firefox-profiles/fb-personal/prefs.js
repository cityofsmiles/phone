...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1617277583);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1617116127);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1616984264);
user_pref("app.update.lastUpdateTime.region-update-timer", 1617195330);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1616984265);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1616468085);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1615772923);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1616375477);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1617277311532");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1617279116532");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1617277312639");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1617298912639");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210323083042");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1617277560");
user_pref("browser.slowStartup.averageTime", 0);
user_pref("browser.slowStartup.samples", 0);
user_pref("browser.startup.homepage_override.buildID", "20210323083042");
...
user_pref("browser.startup.lastColdStartupCheck", 1617277557);
...
user_pref("dom.push.userAgentID", "66e7a7e47bf14a3ebfb564287259ecd6");
user_pref("extensions.activeThemeID", "default-theme@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1617277584);
user_pref("extensions.getAddons.databaseSchema", 6);
user_pref("extensions.incognito.migrated", true);
user_pref("extensions.lastAppBuildId", "20210323083042");
...
user_pref("idle.lastDailyNotification", 1616234043);
user_pref("layout.css.devPixelsPerPx", "1.0");
user_pref("media.gmp-manager.buildID", "20210323083042");
user_pref("media.gmp-manager.lastCheck", 1617116124);
...
user_pref("privacy.purge_trackers.last_purge", "1616234051167");
user_pref("privacy.sanitize.pending", "[]");
user_pref("security.remote_settings.crlite_filters.checked", 1616234631);
user_pref("security.remote_settings.intermediates.checked", 1616234631);
...
user_pref("services.blocklist.addons-mlbf.checked", 1617277304);
user_pref("services.blocklist.gfx.checked", 1617277304);
user_pref("services.blocklist.pinning.checked", 1617116116);
user_pref("services.blocklist.plugins.checked", 1617277304);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1617256358755\"");
user_pref("services.settings.last_update_seconds", 1617277304);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1617277304);
user_pref("services.settings.main.cfr-fxa.last_check", 1617277304);
user_pref("services.settings.main.cfr.last_check", 1617277304);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1617277304);
user_pref("services.settings.main.hijack-blocklists.last_check", 1617277304);
user_pref("services.settings.main.language-dictionaries.last_check", 1617277304);
user_pref("services.settings.main.message-groups.last_check", 1617277304);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1617277304);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1617277304);
user_pref("services.settings.main.password-recipes.last_check", 1617277304);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1617277304);
user_pref("services.settings.main.public-suffix-list.last_check", 1617277304);
user_pref("services.settings.main.search-config.last_check", 1617277304);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1617277304);
user_pref("services.settings.main.search-telemetry.last_check", 1617277304);
user_pref("services.settings.main.sites-classification.last_check", 1617277304);
user_pref("services.settings.main.top-sites.last_check", 1617277304);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1617277304);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1617277304);
user_pref("services.settings.main.whats-new-panel.last_check", 1617277304);
user_pref("services.settings.security.onecrl.checked", 1616234631);
...
user_pref("toolkit.startup.last_success", 1617277551);
...
user_pref("toolkit.telemetry.previousBuildID", "20210323083042");
