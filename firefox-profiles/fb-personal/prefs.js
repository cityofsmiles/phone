...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1618297256);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1618385891);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1618386770);
user_pref("app.update.lastUpdateTime.region-update-timer", 1618275660);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1618386011);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1618297136);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1618288310);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1618297016);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1618385912218");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1618387727218");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1618385913271");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1618407513271");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210411221546");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1618386748");
...
user_pref("browser.startup.lastColdStartupCheck", 1618386743);
...
user_pref("dom.push.userAgentID", "1393ee8fc12b4cd497ad6bddd94686a6");
user_pref("extensions.activeThemeID", "default-theme@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1618297257);
...
user_pref("media.gmp-manager.lastCheck", 1618385888);
...
user_pref("services.blocklist.addons-mlbf.checked", 1618385878);
user_pref("services.blocklist.gfx.checked", 1618385878);
user_pref("services.blocklist.pinning.checked", 1618385878);
user_pref("services.blocklist.plugins.checked", 1618385878);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1618365457602\"");
user_pref("services.settings.last_update_seconds", 1618385878);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1618385878);
user_pref("services.settings.main.cfr-fxa.last_check", 1618385878);
user_pref("services.settings.main.cfr.last_check", 1618385878);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1618385878);
user_pref("services.settings.main.hijack-blocklists.last_check", 1618385878);
user_pref("services.settings.main.language-dictionaries.last_check", 1618385878);
user_pref("services.settings.main.message-groups.last_check", 1618385878);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1618385878);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1618385878);
user_pref("services.settings.main.password-recipes.last_check", 1618385878);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1618385878);
user_pref("services.settings.main.public-suffix-list.last_check", 1618385878);
user_pref("services.settings.main.search-config.last_check", 1618385878);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1618385878);
user_pref("services.settings.main.search-telemetry.last_check", 1618385878);
user_pref("services.settings.main.sites-classification.last_check", 1618385878);
user_pref("services.settings.main.top-sites.last_check", 1618385878);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1618385878);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1618385878);
user_pref("services.settings.main.whats-new-panel.last_check", 1618385878);
...
user_pref("toolkit.startup.last_success", 1618386738);
