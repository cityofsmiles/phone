...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1617531030);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1617531271);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1617531391);
user_pref("app.update.lastUpdateTime.region-update-timer", 1615773375);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1617530790);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1617530910);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1615773495);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1617531151);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1617530826578");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1617532644578");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1617530786310");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1617552386310");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210323083042");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1617530771");
...
user_pref("browser.startup.lastColdStartupCheck", 1617530767);
...
user_pref("dom.push.userAgentID", "621cfeadfa26493fafdb04e0c138afde");
user_pref("extensions.activeThemeID", "default-theme@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1617531031);
...
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{6cd369a8-4ea6-4fe6-b528-2c37fd2e6f20}\",\"addons\":{\"reset-search-defaults@mozilla.com\":{\"version\":\"1.0.6\"}}}");
...
user_pref("idle.lastDailyNotification", 1615948572);
user_pref("media.gmp-manager.buildID", "20210323083042");
user_pref("media.gmp-manager.lastCheck", 1617531184);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("network.prefetch-next", false);
user_pref("network.trr.blocklist_cleanup_done", true);
user_pref("pdfjs.enabledCache.state", true);
user_pref("pdfjs.migrationVersion", 2);
user_pref("places.database.lastMaintenance", 1615773324);
user_pref("places.history.expiration.transient_current_max_pages", 112348);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1615948572132");
user_pref("privacy.sanitize.pending", "[]");
user_pref("security.remote_settings.crlite_filters.checked", 1617531489);
user_pref("security.remote_settings.intermediates.checked", 1617531489);
...
user_pref("services.blocklist.addons-mlbf.checked", 1617531489);
user_pref("services.blocklist.gfx.checked", 1617531489);
user_pref("services.blocklist.pinning.checked", 1617531489);
user_pref("services.blocklist.plugins.checked", 1617531489);
user_pref("services.settings.clock_skew_seconds", -95);
user_pref("services.settings.last_etag", "\"1617495080068\"");
user_pref("services.settings.last_update_seconds", 1617531489);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1617531489);
user_pref("services.settings.main.cfr-fxa.last_check", 1617531489);
user_pref("services.settings.main.cfr.last_check", 1617531489);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1617531489);
user_pref("services.settings.main.hijack-blocklists.last_check", 1617531489);
user_pref("services.settings.main.language-dictionaries.last_check", 1617531489);
user_pref("services.settings.main.message-groups.last_check", 1617531489);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1617531489);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1617531489);
user_pref("services.settings.main.password-recipes.last_check", 1617531489);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1617531489);
user_pref("services.settings.main.public-suffix-list.last_check", 1617531489);
user_pref("services.settings.main.search-config.last_check", 1617531489);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1617531489);
user_pref("services.settings.main.search-telemetry.last_check", 1617531489);
user_pref("services.settings.main.sites-classification.last_check", 1617531489);
user_pref("services.settings.main.top-sites.last_check", 1617531489);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1617531489);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1617531489);
user_pref("services.settings.main.whats-new-panel.last_check", 1617531489);
user_pref("services.settings.security.onecrl.checked", 1617531489);
user_pref("storage.vacuum.last.index", 1);
user_pref("storage.vacuum.last.places.sqlite", 1615773323);
user_pref("toolkit.startup.last_success", 1617530754);
