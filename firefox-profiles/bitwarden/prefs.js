...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1615948955);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1616148804);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1616148792);
user_pref("app.update.lastUpdateTime.region-update-timer", 1615773375);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1615948475);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1615948595);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1615773495);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1615949075);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1616148791053");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1616170391053");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210311122254");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1615948451");
user_pref("browser.slowStartup.averageTime", 9334);
...
user_pref("browser.startup.lastColdStartupCheck", 1616148780);
...
user_pref("dom.push.userAgentID", "e6f1068f14da449fb71a431377145cb8");
user_pref("extensions.activeThemeID", "default-theme@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1615948956);
...
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{067da8d7-f217-41fa-8fc2-c88b27396dcc}\",\"addons\":{\"reset-search-defaults@mozilla.com\":{\"version\":\"1.0.5\"}}}");
...
user_pref("media.gmp-manager.lastCheck", 1616148811);
...
user_pref("security.remote_settings.crlite_filters.checked", 1615948595);
user_pref("security.remote_settings.intermediates.checked", 1615948595);
...
user_pref("services.blocklist.addons-mlbf.checked", 1616148787);
user_pref("services.blocklist.gfx.checked", 1616148787);
user_pref("services.blocklist.pinning.checked", 1615948595);
user_pref("services.blocklist.plugins.checked", 1616148787);
user_pref("services.settings.clock_skew_seconds", 2);
user_pref("services.settings.last_etag", "\"1616140649876\"");
user_pref("services.settings.last_update_seconds", 1616148787);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1616148787);
user_pref("services.settings.main.cfr-fxa.last_check", 1616148787);
user_pref("services.settings.main.cfr.last_check", 1616148787);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1616148787);
user_pref("services.settings.main.hijack-blocklists.last_check", 1616148787);
user_pref("services.settings.main.language-dictionaries.last_check", 1616148787);
user_pref("services.settings.main.message-groups.last_check", 1616148787);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1616148787);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1616148787);
user_pref("services.settings.main.password-recipes.last_check", 1616148787);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1616148787);
user_pref("services.settings.main.public-suffix-list.last_check", 1616148787);
user_pref("services.settings.main.search-config.last_check", 1616148787);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1616148787);
user_pref("services.settings.main.search-telemetry.last_check", 1616148787);
user_pref("services.settings.main.sites-classification.last_check", 1616148787);
user_pref("services.settings.main.top-sites.last_check", 1616148787);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1616148787);
user_pref("services.settings.main.whats-new-panel.last_check", 1616148787);
user_pref("services.settings.security.onecrl.checked", 1615948595);
user_pref("storage.vacuum.last.index", 1);
user_pref("storage.vacuum.last.places.sqlite", 1615773323);
user_pref("toolkit.startup.last_success", 1616148770);
