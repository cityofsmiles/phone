...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1616205441);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1616295509);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1616295629);
user_pref("app.update.lastUpdateTime.region-update-timer", 1615971767);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1616295389);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1616205816);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1615949860);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1616205561);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1616295383944");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1616297157944");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1616295384894");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1616316984894");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210311122254");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1616295370");
user_pref("browser.slowStartup.averageTime", 7387);
...
user_pref("browser.startup.lastColdStartupCheck", 1616295362);
...
user_pref("dom.push.userAgentID", "5bce10f8b60f46e0a3b60e7c6b39b6ff");
user_pref("extensions.activeThemeID", "default-theme@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1616205442);
...
user_pref("media.gmp-manager.lastCheck", 1616295579);
...
user_pref("services.blocklist.addons-mlbf.checked", 1616295376);
user_pref("services.blocklist.gfx.checked", 1616295376);
user_pref("services.blocklist.pinning.checked", 1616233723);
user_pref("services.blocklist.plugins.checked", 1616295376);
user_pref("services.settings.clock_skew_seconds", 1);
user_pref("services.settings.last_etag", "\"1616291861197\"");
user_pref("services.settings.last_update_seconds", 1616295376);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1616295376);
user_pref("services.settings.main.cfr-fxa.last_check", 1616295376);
user_pref("services.settings.main.cfr.last_check", 1616295376);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1616295376);
user_pref("services.settings.main.hijack-blocklists.last_check", 1616295376);
user_pref("services.settings.main.language-dictionaries.last_check", 1616295376);
user_pref("services.settings.main.message-groups.last_check", 1616295376);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1616295376);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1616295376);
user_pref("services.settings.main.password-recipes.last_check", 1616295376);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1616295376);
user_pref("services.settings.main.public-suffix-list.last_check", 1616295376);
user_pref("services.settings.main.search-config.last_check", 1616295376);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1616295376);
user_pref("services.settings.main.search-telemetry.last_check", 1616295376);
user_pref("services.settings.main.sites-classification.last_check", 1616295376);
user_pref("services.settings.main.top-sites.last_check", 1616295376);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1616295376);
user_pref("services.settings.main.whats-new-panel.last_check", 1616295376);
...
user_pref("toolkit.startup.last_success", 1616295357);
