...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1628844774);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1628925203);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1628925683);
user_pref("app.update.lastUpdateTime.region-update-timer", 1628925323);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1628925563);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1628925443);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1628561754);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1628908017);
...
user_pref("browser.region.update.updated", 1628925324);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1628925191123");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1628926976123");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1628925192006");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1628946792006");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210811071140");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1628925180");
...
user_pref("browser.startup.lastColdStartupCheck", 1628925176);
...
user_pref("dom.push.userAgentID", "f514fb27220544c3971841002470ec73");
user_pref("extensions.activeThemeID", "firefox-compact-dark@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1628844774);
...
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{73890f89-5c40-497f-a508-40c4813b75e9}\",\"addons\":{\"reset-search-defaults@mozilla.com\":{\"version\":\"2.1.0\"}}}");
...
user_pref("idle.lastDailyNotification", 1628925525);
user_pref("layout.css.devPixelsPerPx", "1.0");
user_pref("media.gmp-manager.buildID", "20210811071140");
user_pref("media.gmp-manager.lastCheck", 1628908012);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("network.prefetch-next", false);
user_pref("network.trr.blocklist_cleanup_done", true);
user_pref("pdfjs.enabledCache.state", false);
user_pref("pdfjs.migrationVersion", 2);
user_pref("places.database.lastMaintenance", 1628925525);
user_pref("places.history.expiration.transient_current_max_pages", 112348);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1628925525449");
user_pref("privacy.sanitize.pending", "[]");
user_pref("security.remote_settings.crlite_filters.checked", 1628925443);
user_pref("security.remote_settings.intermediates.checked", 1628925443);
...
user_pref("services.blocklist.addons-mlbf.checked", 1628925443);
user_pref("services.blocklist.gfx.checked", 1628925443);
...
user_pref("services.settings.last_etag", "\"1628905629839\"");
user_pref("services.settings.last_update_seconds", 1628925443);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1628925443);
user_pref("services.settings.main.cfr-fxa.last_check", 1628925443);
user_pref("services.settings.main.cfr.last_check", 1628925443);
user_pref("services.settings.main.doh-config.last_check", 1628925443);
user_pref("services.settings.main.doh-providers.last_check", 1628925443);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1628925443);
user_pref("services.settings.main.hijack-blocklists.last_check", 1628925443);
user_pref("services.settings.main.language-dictionaries.last_check", 1628925443);
user_pref("services.settings.main.message-groups.last_check", 1628925443);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1628925443);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1628925443);
user_pref("services.settings.main.password-recipes.last_check", 1628925443);
user_pref("services.settings.main.password-rules.last_check", 1628925443);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1628925443);
user_pref("services.settings.main.public-suffix-list.last_check", 1628925443);
user_pref("services.settings.main.query-stripping.last_check", 1628925443);
user_pref("services.settings.main.search-config.last_check", 1628925443);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1628925443);
user_pref("services.settings.main.search-telemetry.last_check", 1628925443);
user_pref("services.settings.main.sites-classification.last_check", 1628925443);
user_pref("services.settings.main.top-sites.last_check", 1628925443);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1628925443);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1628925443);
user_pref("services.settings.main.whats-new-panel.last_check", 1628925443);
user_pref("services.settings.security.onecrl.checked", 1628925443);
...
user_pref("toolkit.startup.last_success", 1628925171);
