...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1618532598);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1618275500);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1618275509);
user_pref("app.update.lastUpdateTime.region-update-timer", 1617697875);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1618532496);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1618007506);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1618275620);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1617697015);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1618532484336");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1618534296336");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1618532489209");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1618554089209");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210411221546");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1618532574");
...
user_pref("browser.startup.lastColdStartupCheck", 1618532571);
...
user_pref("dom.push.userAgentID", "4bc693ddae954ae1b6a6fadb28384fa3");
user_pref("extensions.activeThemeID", "default-theme@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1618532599);
...
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{b9cfb335-1c60-457a-9d52-90424e74ac15}\",\"addons\":{\"reset-search-defaults@mozilla.com\":{\"version\":\"1.0.6\"}}}");
...
user_pref("idle.lastDailyNotification", 1616233916);
user_pref("layout.css.devPixelsPerPx", "1.0");
user_pref("media.gmp-manager.buildID", "20210411221546");
user_pref("media.gmp-manager.lastCheck", 1618275526);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("network.prefetch-next", false);
user_pref("network.trr.blocklist_cleanup_done", true);
user_pref("pdfjs.enabledCache.state", false);
user_pref("pdfjs.migrationVersion", 2);
user_pref("places.database.lastMaintenance", 1615949841);
user_pref("places.history.expiration.transient_current_max_pages", 112348);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1616233916522");
user_pref("privacy.sanitize.pending", "[]");
user_pref("security.remote_settings.crlite_filters.checked", 1615971750);
user_pref("security.remote_settings.intermediates.checked", 1615971750);
...
user_pref("services.blocklist.addons-mlbf.checked", 1618532474);
user_pref("services.blocklist.gfx.checked", 1618532474);
user_pref("services.blocklist.pinning.checked", 1616233723);
user_pref("services.blocklist.plugins.checked", 1618532474);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1618520256346\"");
user_pref("services.settings.last_update_seconds", 1618532474);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1618532474);
user_pref("services.settings.main.cfr-fxa.last_check", 1618532474);
user_pref("services.settings.main.cfr.last_check", 1618532474);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1618532474);
user_pref("services.settings.main.hijack-blocklists.last_check", 1618532474);
user_pref("services.settings.main.language-dictionaries.last_check", 1618532474);
user_pref("services.settings.main.message-groups.last_check", 1618532474);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1618532474);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1618532474);
user_pref("services.settings.main.password-recipes.last_check", 1618532474);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1618532474);
user_pref("services.settings.main.public-suffix-list.last_check", 1618532474);
user_pref("services.settings.main.search-config.last_check", 1618532474);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1618532474);
user_pref("services.settings.main.search-telemetry.last_check", 1618532474);
user_pref("services.settings.main.sites-classification.last_check", 1618532474);
user_pref("services.settings.main.top-sites.last_check", 1618532474);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1618532474);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1618532474);
user_pref("services.settings.main.whats-new-panel.last_check", 1618532474);
user_pref("services.settings.security.onecrl.checked", 1615971750);
...
user_pref("storage.vacuum.last.places.sqlite", 1615949841);
user_pref("toolkit.startup.last_success", 1618532566);
