...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1617434736);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1617195338);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1616984343);
user_pref("app.update.lastUpdateTime.region-update-timer", 1615971767);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1617277715);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1616984351);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1615949860);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1616335493);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1617672262394");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1617674088394");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1617434729494");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1617456329494");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210323083042");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1617672247");
user_pref("browser.slowStartup.averageTime", 6387);
...
user_pref("browser.startup.lastColdStartupCheck", 1617672243);
...
user_pref("dom.push.userAgentID", "e5ec156386904cf29e6ba1dbbd2b0d50");
user_pref("extensions.activeThemeID", "default-theme@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1617434737);
...
user_pref("media.gmp-manager.lastCheck", 1616984365);
...
user_pref("services.blocklist.addons-mlbf.checked", 1617531544);
user_pref("services.blocklist.gfx.checked", 1617531544);
user_pref("services.blocklist.pinning.checked", 1616233723);
user_pref("services.blocklist.plugins.checked", 1617531544);
user_pref("services.settings.clock_skew_seconds", 1);
user_pref("services.settings.last_etag", "\"1617495080068\"");
user_pref("services.settings.last_update_seconds", 1617531544);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1617531544);
user_pref("services.settings.main.cfr-fxa.last_check", 1617531544);
user_pref("services.settings.main.cfr.last_check", 1617531544);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1617531544);
user_pref("services.settings.main.hijack-blocklists.last_check", 1617531544);
user_pref("services.settings.main.language-dictionaries.last_check", 1617531544);
user_pref("services.settings.main.message-groups.last_check", 1617531544);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1617531544);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1617531544);
user_pref("services.settings.main.password-recipes.last_check", 1617531544);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1617531544);
user_pref("services.settings.main.public-suffix-list.last_check", 1617531544);
user_pref("services.settings.main.search-config.last_check", 1617531544);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1617531544);
user_pref("services.settings.main.search-telemetry.last_check", 1617531544);
user_pref("services.settings.main.sites-classification.last_check", 1617531544);
user_pref("services.settings.main.top-sites.last_check", 1617531544);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1617531544);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1617531544);
user_pref("services.settings.main.whats-new-panel.last_check", 1617531544);
...
user_pref("toolkit.startup.last_success", 1617672236);
