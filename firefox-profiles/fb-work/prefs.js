...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1615949740);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1616154655);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1616154662);
user_pref("app.update.lastUpdateTime.region-update-timer", 1615971767);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1616154776);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1615958097);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1615949860);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1615957977);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1616154655002");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1616156426002");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1616154658200");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1616176258200");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210311122254");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1615971744");
...
user_pref("browser.startup.lastColdStartupCheck", 1616154631);
...
user_pref("dom.push.userAgentID", "835b88b62ead4fbeb1db0ac7499412f7");
user_pref("extensions.activeThemeID", "default-theme@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1615949741);
...
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{b96bce56-10bf-4930-b931-8c88d3077b44}\",\"addons\":{\"reset-search-defaults@mozilla.com\":{\"version\":\"1.0.5\"}}}");
...
user_pref("idle.lastDailyNotification", 1615949840);
user_pref("layout.css.devPixelsPerPx", "1.0");
user_pref("media.gmp-manager.buildID", "20210314145242");
user_pref("media.gmp-manager.lastCheck", 1615949543);
...
user_pref("privacy.purge_trackers.last_purge", "1615949841007");
...
user_pref("services.blocklist.addons-mlbf.checked", 1616154642);
user_pref("services.blocklist.gfx.checked", 1616154642);
user_pref("services.blocklist.pinning.checked", 1615971750);
user_pref("services.blocklist.plugins.checked", 1616154642);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1616140649876\"");
user_pref("services.settings.last_update_seconds", 1616154642);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1616154642);
user_pref("services.settings.main.cfr-fxa.last_check", 1616154642);
user_pref("services.settings.main.cfr.last_check", 1616154642);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1616154642);
user_pref("services.settings.main.hijack-blocklists.last_check", 1616154642);
user_pref("services.settings.main.language-dictionaries.last_check", 1616154642);
user_pref("services.settings.main.message-groups.last_check", 1616154642);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1616154642);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1616154642);
user_pref("services.settings.main.password-recipes.last_check", 1616154642);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1616154642);
user_pref("services.settings.main.public-suffix-list.last_check", 1616154642);
user_pref("services.settings.main.search-config.last_check", 1616154642);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1616154642);
user_pref("services.settings.main.search-telemetry.last_check", 1616154642);
user_pref("services.settings.main.sites-classification.last_check", 1616154642);
user_pref("services.settings.main.top-sites.last_check", 1616154642);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1616154642);
user_pref("services.settings.main.whats-new-panel.last_check", 1616154642);
...
user_pref("toolkit.startup.last_success", 1616154622);
