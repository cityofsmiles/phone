...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1628746732);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1628746852);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1628746758);
user_pref("app.update.lastUpdateTime.region-update-timer", 1628311903);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1628722133);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1628721893);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1628561754);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1628649934);
...
user_pref("browser.region.update.updated", 1628311905);
user_pref("browser.rights.3.shown", true);
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1628746718803");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1628748524803");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1628746719726");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1628768319726");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210811071140");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1628746707");
user_pref("browser.slowStartup.averageTime", 4908);
...
user_pref("browser.startup.homepage_override.once", "{\"message_id\":\"WNP_MOMENTS_4\",\"url\":\"https://www.mozilla.org/firefox/welcome/4/\",\"expire\":1616759443016}");
user_pref("browser.startup.lastColdStartupCheck", 1628746705);
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1616154640955");
...
user_pref("dom.push.userAgentID", "7fec25e301a949818d0015692f617121");
user_pref("extensions.activeThemeID", "firefox-compact-dark@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1628746733);
...
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{267b2fac-b2f5-45cc-83e4-db0f24bdf674}\",\"addons\":{\"reset-search-defaults@mozilla.com\":{\"version\":\"2.1.0\"},\"addons-search-detection@mozilla.com\":{\"version\":\"1.0.1\"}}}");
...
user_pref("idle.lastDailyNotification", 1628317120);
user_pref("layout.css.devPixelsPerPx", "1.0");
user_pref("media.gmp-manager.buildID", "20210723064703");
user_pref("media.gmp-manager.lastCheck", 1628639022);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("network.prefetch-next", false);
user_pref("network.trr.blocklist_cleanup_done", true);
user_pref("pdfjs.enabledCache.state", false);
user_pref("pdfjs.migrationVersion", 2);
user_pref("places.database.lastMaintenance", 1628317121);
user_pref("places.history.expiration.transient_current_max_pages", 112348);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1628317120873");
user_pref("privacy.sanitize.pending", "[]");
user_pref("security.remote_settings.crlite_filters.checked", 1628120843);
user_pref("security.remote_settings.intermediates.checked", 1628120843);
...
user_pref("services.blocklist.addons-mlbf.checked", 1628746709);
user_pref("services.blocklist.gfx.checked", 1628746709);
user_pref("services.blocklist.pinning.checked", 1626049069);
user_pref("services.blocklist.plugins.checked", 1621893072);
user_pref("services.settings.clock_skew_seconds", 1);
user_pref("services.settings.last_etag", "\"1628733012990\"");
user_pref("services.settings.last_update_seconds", 1628746709);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1628746709);
user_pref("services.settings.main.cfr-fxa.last_check", 1628746709);
user_pref("services.settings.main.cfr.last_check", 1628746709);
user_pref("services.settings.main.doh-config.last_check", 1628746709);
user_pref("services.settings.main.doh-providers.last_check", 1628746709);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1628746709);
user_pref("services.settings.main.hijack-blocklists.last_check", 1628746709);
user_pref("services.settings.main.language-dictionaries.last_check", 1628746709);
user_pref("services.settings.main.message-groups.last_check", 1628746709);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1628746709);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1628746709);
user_pref("services.settings.main.password-recipes.last_check", 1628746709);
user_pref("services.settings.main.password-rules.last_check", 1628746709);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1628746709);
user_pref("services.settings.main.public-suffix-list.last_check", 1628746709);
user_pref("services.settings.main.query-stripping.last_check", 1628746709);
user_pref("services.settings.main.search-config.last_check", 1628746709);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1628746709);
user_pref("services.settings.main.search-telemetry.last_check", 1628746709);
user_pref("services.settings.main.sites-classification.last_check", 1628746709);
user_pref("services.settings.main.top-sites.last_check", 1628746709);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1628746709);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1628746709);
user_pref("services.settings.main.whats-new-panel.last_check", 1628746709);
user_pref("services.settings.security.onecrl.checked", 1628120843);
...
user_pref("storage.vacuum.last.places.sqlite", 1627449156);
user_pref("toolkit.startup.last_success", 1628746700);
