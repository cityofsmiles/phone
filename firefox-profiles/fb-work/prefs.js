...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1625527945);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1625541905);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1625534175);
user_pref("app.update.lastUpdateTime.region-update-timer", 1625276121);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1625528185);
...
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1625534091);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1625610564899");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1625612341899");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1625610566419");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1625632166419");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210623132525");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1625610543");
...
user_pref("browser.startup.lastColdStartupCheck", 1625610538);
...
user_pref("dom.push.userAgentID", "030c59ca342a4cfeaeaead732a251cee");
user_pref("extensions.activeThemeID", "firefox-compact-dark@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1625527946);
...
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{7099b6a3-9381-41fc-83d8-f992619a0680}\",\"addons\":{\"reset-search-defaults@mozilla.com\":{\"version\":\"2.0.0\"}}}");
...
user_pref("media.gmp-manager.lastCheck", 1625528118);
...
user_pref("security.remote_settings.crlite_filters.checked", 1625276601);
user_pref("security.remote_settings.intermediates.checked", 1625276601);
...
user_pref("services.blocklist.addons-mlbf.checked", 1625610563);
user_pref("services.blocklist.gfx.checked", 1625610563);
user_pref("services.blocklist.pinning.checked", 1625276601);
user_pref("services.blocklist.plugins.checked", 1621893072);
user_pref("services.settings.clock_skew_seconds", 1);
user_pref("services.settings.last_etag", "\"1625605093764\"");
user_pref("services.settings.last_update_seconds", 1625610563);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1625610563);
user_pref("services.settings.main.cfr-fxa.last_check", 1625610563);
user_pref("services.settings.main.cfr.last_check", 1625610563);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1625610563);
user_pref("services.settings.main.hijack-blocklists.last_check", 1625610563);
user_pref("services.settings.main.language-dictionaries.last_check", 1625610563);
user_pref("services.settings.main.message-groups.last_check", 1625610563);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1625610563);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1625610563);
user_pref("services.settings.main.password-recipes.last_check", 1625610563);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1625610563);
user_pref("services.settings.main.public-suffix-list.last_check", 1625610563);
user_pref("services.settings.main.search-config.last_check", 1625610563);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1625610563);
user_pref("services.settings.main.search-telemetry.last_check", 1625610563);
user_pref("services.settings.main.sites-classification.last_check", 1625610563);
user_pref("services.settings.main.top-sites.last_check", 1625610563);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1625610563);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1625610563);
user_pref("services.settings.main.whats-new-panel.last_check", 1625610563);
user_pref("services.settings.security.onecrl.checked", 1625275984);
...
user_pref("toolkit.startup.last_success", 1625610532);
