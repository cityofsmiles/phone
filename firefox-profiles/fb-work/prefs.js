...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1626049517);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1626049067);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1626049328);
user_pref("app.update.lastUpdateTime.region-update-timer", 1625276121);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1626049187);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1625610564);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1625276241);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1626399662);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1626399671672");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1626401488672");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1626399676552");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1626421276552");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210713232748");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1626399644");
...
user_pref("browser.startup.lastColdStartupCheck", 1626399637);
...
user_pref("dom.push.userAgentID", "97352137e68e4c1eaad0a1ce36aae854");
user_pref("extensions.activeThemeID", "firefox-compact-dark@mozilla.org");
user_pref("extensions.blocklist.pingCountVersion", -1);
user_pref("extensions.databaseSchema", 33);
user_pref("extensions.getAddons.cache.lastUpdate", 1626049520);
...
user_pref("idle.lastDailyNotification", 1625276238);
user_pref("layout.css.devPixelsPerPx", "1.0");
user_pref("media.gmp-manager.buildID", "20210623132525");
user_pref("media.gmp-manager.lastCheck", 1626049068);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("network.prefetch-next", false);
user_pref("network.trr.blocklist_cleanup_done", true);
user_pref("pdfjs.enabledCache.state", false);
user_pref("pdfjs.migrationVersion", 2);
user_pref("places.database.lastMaintenance", 1625276238);
user_pref("places.history.expiration.transient_current_max_pages", 112348);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1625276238284");
user_pref("privacy.sanitize.pending", "[]");
user_pref("security.remote_settings.crlite_filters.checked", 1626049069);
user_pref("security.remote_settings.intermediates.checked", 1626049069);
...
user_pref("services.blocklist.addons-mlbf.checked", 1626399652);
user_pref("services.blocklist.gfx.checked", 1626399652);
...
user_pref("services.settings.last_etag", "\"1626382692701\"");
user_pref("services.settings.last_update_seconds", 1626399652);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1626399652);
user_pref("services.settings.main.cfr-fxa.last_check", 1626399652);
user_pref("services.settings.main.cfr.last_check", 1626399652);
user_pref("services.settings.main.doh-config.last_check", 1626399652);
user_pref("services.settings.main.doh-providers.last_check", 1626399652);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1626399652);
user_pref("services.settings.main.hijack-blocklists.last_check", 1626399652);
user_pref("services.settings.main.language-dictionaries.last_check", 1626399652);
user_pref("services.settings.main.message-groups.last_check", 1626399652);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1626399652);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1626399652);
user_pref("services.settings.main.password-recipes.last_check", 1626399652);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1626399652);
user_pref("services.settings.main.public-suffix-list.last_check", 1626399652);
user_pref("services.settings.main.search-config.last_check", 1626399652);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1626399652);
user_pref("services.settings.main.search-telemetry.last_check", 1626399652);
user_pref("services.settings.main.sites-classification.last_check", 1626399652);
user_pref("services.settings.main.top-sites.last_check", 1626399652);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1626399652);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1626399652);
user_pref("services.settings.main.whats-new-panel.last_check", 1626399652);
user_pref("services.settings.security.onecrl.checked", 1626049069);
...
user_pref("toolkit.startup.last_success", 1626399628);
