...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1618007504783");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1618009333783");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1618007506655");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1618029106655");
user_pref("browser.search.region", "PH");
user_pref("browser.sessionhistory.max_total_viewers", 1);
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20210323083042");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1618007484");
user_pref("browser.slowStartup.averageTime", 5907);
...
user_pref("browser.startup.lastColdStartupCheck", 1618007480);
...
user_pref("dom.push.userAgentID", "d6805306be3f4db68ef0fe56b2493b8b");
...
user_pref("services.blocklist.addons-mlbf.checked", 1618007506);
user_pref("services.blocklist.gfx.checked", 1618007506);
user_pref("services.blocklist.pinning.checked", 1616233723);
user_pref("services.blocklist.plugins.checked", 1618007506);
user_pref("services.settings.clock_skew_seconds", 0);
user_pref("services.settings.last_etag", "\"1617989709562\"");
user_pref("services.settings.last_update_seconds", 1618007506);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1618007506);
user_pref("services.settings.main.cfr-fxa.last_check", 1618007506);
user_pref("services.settings.main.cfr.last_check", 1618007506);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1618007506);
user_pref("services.settings.main.hijack-blocklists.last_check", 1618007506);
user_pref("services.settings.main.language-dictionaries.last_check", 1618007506);
user_pref("services.settings.main.message-groups.last_check", 1618007506);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1618007506);
user_pref("services.settings.main.partitioning-exempt-urls.last_check", 1618007506);
user_pref("services.settings.main.password-recipes.last_check", 1618007506);
user_pref("services.settings.main.pioneer-study-addons-v1.last_check", 1618007506);
user_pref("services.settings.main.public-suffix-list.last_check", 1618007506);
user_pref("services.settings.main.search-config.last_check", 1618007506);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1618007506);
user_pref("services.settings.main.search-telemetry.last_check", 1618007506);
user_pref("services.settings.main.sites-classification.last_check", 1618007506);
user_pref("services.settings.main.top-sites.last_check", 1618007506);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1618007506);
user_pref("services.settings.main.websites-with-shared-credential-backends.last_check", 1618007506);
user_pref("services.settings.main.whats-new-panel.last_check", 1618007506);
...
user_pref("toolkit.startup.last_success", 1618007473);
